    ...
    return (
        <View style={{ flex: 1 }}>
            ...
            <ScrollView contentContainerStyle={styles.contentContainerStyle}>
                ...
                <TextInput style={styles.summaryInput} multiline={true} placeholder="Enter summary here..." />

                <AppText>Note: You are not eligible for any reward if you do not have active paid subscription</AppText>
                <Button label="Submit" />
            </ScrollView>
        </View>
    );
